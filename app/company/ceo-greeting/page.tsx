...
export const metadata = {
  ...
  description:
    "A message from the CEO of Wellins Inc. about our commitment to industrial engineering excellence.",
};
          ...
          <div className="grid items-start gap-12 lg:grid-cols-5 lg:gap-20">
            ...
            <div className="lg:col-span-3">
              <div className="prose prose-lg max-w-none text-muted-foreground">
                ...
                <p className="mt-6">
                  For nearly three decades, Wellins Inc. has been at the
                  forefront of industrial engineering, delivering
                  precision-driven solutions that power American manufacturing.
                  What started as a small team with big ambitions has grown into
                  a nationally recognized leader in industrial piping, HVAC
                  systems, equipment installation, and fire protection.
                </p>

                <p className="mt-4">
                  Our success is built on a simple foundation: we treat every
                  project as if it were our own facility. This means never
                  compromising on safety, always pursuing the highest standards
                  of quality, and continuously investing in our people and
                  capabilities.
                </p>
                ...
                <p className="mt-4">
                  ...
                  skilled tradespeople are ready to bring your vision to life
                  with the precision and reliability that has defined our
