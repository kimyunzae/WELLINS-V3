...
export const highPressureVesselsService = {
  ...
  benefits: [
    {
      ...
      description:
        "Deep knowledge of ASME Section VIII requirements ensures compliant installations.",
    },
    {
      title: "Heavy Rigging",
      description:
        "Experienced crews safely handle the largest and heaviest pressure vessels.",
    },
    {
      title: "Quality Welding",
      description:
        "ASME-certified welders for all vessel modifications and repairs.",
    },
    {
      title: "Testing Services",
      description:
        "Complete hydrostatic and pneumatic testing with certified documentation.",
    },
    {
      title: "Regulatory Support",
      description:
        "Assistance with jurisdictional requirements and National Board registration.",
    },
    {
      title: "Lifecycle Support",
      description:
        "From initial installation through maintenance and eventual replacement.",
    },
  ],
} satisfies Service;
