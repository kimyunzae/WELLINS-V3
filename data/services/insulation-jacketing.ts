...
export const insulationJacketingService = {
  ...
  image: "/images/service-insulation-detail.webp",
  ...
  benefits: [
    {
      ...
      description:
        "Properly designed insulation systems significantly reduce energy costs and heat loss.",
    },
    {
      title: "Personnel Protection",
      description:
        "Insulation keeps surface temperatures safe for workers in the facility.",
    },
    {
      title: "Process Control",
      description:
        "Maintain precise temperatures for critical process applications.",
    },
    {
      title: "Corrosion Prevention",
      description:
        "Jacketing systems protect insulation and piping from weather and physical damage.",
    },
    {
      title: "Code Compliance",
      description:
        "All installations meet ASTM, ASHRAE, and industry insulation standards.",
    },
    {
      title: "Long Service Life",
      description:
        "Quality materials and installation ensure decades of reliable performance.",
    },
  ],
} satisfies Service;
