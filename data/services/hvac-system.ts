...
export const hvacSystemService = {
  slug: "hvac-system",
  title: "HVAC System",
  description:
  ...
  benefits: [
    {
      ...
      description:
        "Systems designed to minimize operating costs while meeting environmental requirements.",
    },
    {
      title: "Process Integration",
      description:
        "HVAC systems coordinated with production processes for optimal performance.",
    },
    {
      title: "Compliance",
      description:
        "Systems meet ASHRAE, OSHA, and industry-specific environmental standards.",
    },
    {
      title: "Reliability",
      description:
        "Redundant designs ensure continuous operation of critical environmental controls.",
    },
    {
      title: "Smart Controls",
      description:
        "Advanced BAS integration for monitoring, optimization, and predictive maintenance.",
    },
    {
      title: "Service Support",
      description:
        "Ongoing maintenance programs keep your systems running at peak efficiency.",
    },
  ],
} satisfies Service;
